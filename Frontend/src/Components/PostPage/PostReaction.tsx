        ...
        <>
            <section className="post-reaction-sidebar post-sticky-4px">
                <div className="post-reaction-bottom">
                    <button className="post-action-icons">
                        <span className="post-single-heart icons-p-2 radius-50">
                            {/* TODO: */}
                            <RiHeart2Line
                    ...
                    <button className="post-action-icons">
                        <span className="post-single-unicorn icons-p-2 radius-50">
                            {/* TODO: */}
                            <svg
                        ...
                        <span>{unicornCount}</span>
                    </button>
                    <button className="post-action-icons">
                        <span className="post-single-bookmark icons-p-2 radius-50">
                            {/* TODO: */}
